    ...
    <div ref={containerRef} className="slide-container" style={{ zIndex: isActive ? 10 : 1 }}>
      <div className="slide-content">
        ...
        <div style={{ display: 'flex', gap: '2rem', maxWidth: '1200px' }}>
          ...
          <div ref={card1Ref} className="tech-panel" style={{ flex: 1, borderTop: '2px solid #ef4444' }}>
          ...
          <div ref={card2Ref} className="tech-panel" style={{ flex: 1, borderTop: '2px solid var(--accent-primary)' }}>
