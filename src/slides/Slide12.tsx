    ...
    <div ref={containerRef} className="slide-container" style={{ zIndex: isActive ? 10 : 1 }}>
      <div className="slide-content">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '800px' }}>
          ...
          <div ref={el => el && (pointsRef.current[0] = el)} className="tech-panel" style={{ borderLeft: '2px solid var(--accent-primary)' }}>
          ...
          <div ref={el => el && (pointsRef.current[1] = el)} className="tech-panel" style={{ borderLeft: '2px solid var(--accent-primary)' }}>
          ...
          <div ref={el => el && (pointsRef.current[2] = el)} className="tech-panel" style={{ borderLeft: '2px solid var(--accent-primary)' }}>
