...
const Slide2: React.FC<SlideProps> = ({ isActive, currentStep, onTotalStepsChange }) => {
  ...
  useEffect(() => {
    if (isActive) {
      ...
      if (titleRef.current) scrambleText(titleRef.current, "THE TRADITIONAL\nBOTTLENECK", 1200);
  ...
  const boxStyle: React.CSSProperties = {
    flex: 1, padding: '3rem 2rem', margin: '0 1rem', display: 'flex',
    ...
    <div ref={containerRef} className="slide-container" style={{ zIndex: isActive ? 10 : 1 }}>
      <div className="slide-content" style={{ justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', width: '100%', maxWidth: '1400px' }}>
          ...
          <div ref={box1Ref} className="tech-panel interactable" style={boxStyle}>
          ...
          <div ref={box2Ref} className="tech-panel interactable" style={boxStyle}>
          ...
          <div ref={box3Ref} className="tech-panel interactable" style={{ ...boxStyle, borderColor: '#ef4444' }}>
